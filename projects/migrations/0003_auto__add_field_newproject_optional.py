...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NewProject.optional'
        db.add_column(u'projects_newproject', 'optional',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NewProject.optional'
        db.delete_column(u'projects_newproject', 'optional')
