...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NewProject.customer_id'
        db.add_column(u'projects_newproject', 'customer_id',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['home.Customers'], unique=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NewProject.customer_id'
        db.delete_column(u'projects_newproject', 'customer_id_id')
