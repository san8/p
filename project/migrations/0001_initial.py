...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'project_newproject', (
            ...
            ('file_type', self.gf('django.db.models.fields.CharField')(default='', max_length=10)),
            ('vcf_file', self.gf('django.db.models.fields.files.FileField')(default='', max_length=100)),
            ('total_fastq_files', self.gf('django.db.models.fields.CharField')(default='', max_length=2)),
            ('fastq_file1', self.gf('django.db.models.fields.URLField')(default='', max_length=200)),
            ('fastq_file2', self.gf('django.db.models.fields.URLField')(default='', max_length=200)),
    ...
    models = {
        ...
        u'project.newproject': {
            ...
            'fastq_file1': ('django.db.models.fields.URLField', [], {'default': "''", 'max_length': '200'}),
            'fastq_file2': ('django.db.models.fields.URLField', [], {'default': "''", 'max_length': '200'}),
