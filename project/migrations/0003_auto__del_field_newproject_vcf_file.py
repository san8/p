...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'NewProject.vcf_file'
        db.delete_column(u'project_newproject', 'vcf_file')


    def backwards(self, orm):
        # Adding field 'NewProject.vcf_file'
        db.add_column(u'project_newproject', 'vcf_file',
                      self.gf('django.db.models.fields.files.FileField')(default='vcf_file', max_length=100, blank=True),
                      keep_default=False)
