...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NewProject.file1_read'
        db.add_column(u'project_newproject', 'file1_read',
                      self.gf('django.db.models.fields.CharField')(default='Forward', max_length='8'),
                      keep_default=False)

        # Adding field 'NewProject.file2_read'
        db.add_column(u'project_newproject', 'file2_read',
                      self.gf('django.db.models.fields.CharField')(default='Backward', max_length='8'),
                      keep_default=False)

        # Adding field 'NewProject.vcf_file1'
        db.add_column(u'project_newproject', 'vcf_file1',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NewProject.file1_read'
        db.delete_column(u'project_newproject', 'file1_read')

        # Deleting field 'NewProject.file2_read'
        db.delete_column(u'project_newproject', 'file2_read')

        # Deleting field 'NewProject.vcf_file1'
        db.delete_column(u'project_newproject', 'vcf_file1')
