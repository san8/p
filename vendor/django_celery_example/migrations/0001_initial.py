...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'django_celery_example_samplecount', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('num', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'django_celery_example', ['SampleCount'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'django_celery_example_samplecount')
    ...
    models = {
        ...
        u'django_celery_example.userprofile': {
