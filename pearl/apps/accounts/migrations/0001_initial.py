...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'accounts_payment', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='payments_to_user', to=orm['auth.User'])),
            ('payment', self.gf('django.db.models.fields.related.ForeignKey')(related_name='paypal_id', to=orm['ipn.PayPalIPN'])),
        ))
        db.send_create_signal(u'accounts', ['Payment'])

        # Adding model 'Discount'
        db.create_table(u'accounts_discount', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('fastq', self.gf('django.db.models.fields.FloatField')(default=0.0)),
            ('vcf', self.gf('django.db.models.fields.FloatField')(default=0.0)),
        ))
        db.send_create_signal(u'accounts', ['Discount'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'accounts_discount')
    ...
    models = {
        ...
        u'accounts.discount': {
            ...
            'fastq': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['auth.User']", 'unique': 'True'}),
            'vcf': ('django.db.models.fields.FloatField', [], {'default': '0.0'})
        },
        u'accounts.payment': {
            'Meta': {'object_name': 'Payment'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'payment': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'paypal_id'", 'to': u"orm['ipn.PayPalIPN']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'payments_to_user'", 'to': u"orm['auth.User']"})
        },
        u'auth.group': {
