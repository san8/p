...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'NewProjectDisTis'
        db.delete_table(u'project_newprojectdistis')


    def backwards(self, orm):
        # Adding model 'NewProjectDisTis'
        db.create_table(u'project_newprojectdistis', (
            ('tissue', self.gf('django.db.models.fields.CharField')(max_length=200, null=True)),
            ('disease', self.gf('django.db.models.fields.CharField')(max_length=200, null=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'project', ['NewProjectDisTis'])
    ...
    models = {
        ...
        u'project.projectmeshtissues': {
            'Meta': {'object_name': 'ProjectMeshTissues', 'db_table': "'project_mesh_tissues'", 'managed': 'False'},
            'descriptornamestring': ('django.db.models.fields.CharField', [], {'max_length': '41', 'db_column': "'DescriptorNameString'", 'blank': 'True'}),
            'descriptorui': ('django.db.models.fields.CharField', [], {'max_length': '7', 'db_column': "'DescriptorUI'"}),
            'id': ('django.db.models.fields.IntegerField', [], {'primary_key': 'True', 'db_column': "'ID'"}),
            'treenumber': ('django.db.models.fields.TextField', [], {'db_column': "'TreeNumber'", 'blank': 'True'})
        }
    }
