...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MeshTissues'
        db.create_table(u'project_meshtissues', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('descriptorui', self.gf('django.db.models.fields.CharField')(max_length=7)),
            ('descriptornamestring', self.gf('django.db.models.fields.CharField')(max_length=41, blank=True)),
            ('treenumber', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal(u'project', ['MeshTissues'])


    def backwards(self, orm):
        # Deleting model 'MeshTissues'
        db.delete_table(u'project_meshtissues')
