...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MeshDiseases'
        db.create_table(u'project_meshdiseases', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('descriptorui', self.gf('django.db.models.fields.CharField')(max_length=7)),
            ('descriptornamestring', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('treenumber', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal(u'project', ['MeshDiseases'])


    def backwards(self, orm):
        # Deleting model 'MeshDiseases'
        db.delete_table(u'project_meshdiseases')
    ...
    models = {
        ...
        u'project.meshdiseases': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'treenumber': ('django.db.models.fields.TextField', [], {'blank': 'True'})
        },
        u'project.meshtissues': {
            'Meta': {'object_name': 'MeshTissues'},
