...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'accounts_customer', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)

        # Adding field 'Customer.phone_number'
        db.add_column(u'accounts_customer', 'phone_number',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'accounts_customer', 'name')

        # Deleting field 'Customer.phone_number'
        db.delete_column(u'accounts_customer', 'phone_number')
