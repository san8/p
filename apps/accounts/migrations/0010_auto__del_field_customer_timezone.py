...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'accounts_customer', 'timezone')


    def backwards(self, orm):
        # Adding field 'Customer.timezone'
        db.add_column(u'accounts_customer', 'timezone',
                      self.gf('django.db.models.fields.CharField')(default=datetime.datetime(2014, 7, 14, 0, 0), max_length=30),
                      keep_default=False)
