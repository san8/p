...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Customer.trash'
        db.add_column(u'accounts_customer', 'trash',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Customer.trash'
        db.delete_column(u'accounts_customer', 'trash')
    ...
    models = {
        u'accounts.customer': {
            ...
            'trash': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50', 'blank': 'True'}),
