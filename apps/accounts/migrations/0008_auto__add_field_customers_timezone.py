...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Customers.timezone'
        db.add_column(u'accounts_customers', 'timezone',
                      self.gf('django.db.models.fields.CharField')(default='UTC', max_length=30),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Customers.timezone'
        db.delete_column(u'accounts_customers', 'timezone')
