...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'NewProject.file_type'
        db.alter_column(u'project_newproject', 'file_type', self.gf('django.db.models.fields.CharField')(max_length=10))

    def backwards(self, orm):

        # Changing field 'NewProject.file_type'
        db.alter_column(u'project_newproject', 'file_type', self.gf('django.db.models.fields.CharField')(max_length=5))
    ...
    models = {
        ...
        u'project.newproject': {
            ...
            'total_fastq_files': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
