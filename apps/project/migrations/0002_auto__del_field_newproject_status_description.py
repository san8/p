...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'NewProject.status_description'
        db.delete_column(u'project_newproject', 'status_description')


    def backwards(self, orm):
        # Adding field 'NewProject.status_description'
        db.add_column(u'project_newproject', 'status_description',
                      self.gf('django.db.models.fields.CharField')(default='Uploading Raw Files.', max_length=20),
                      keep_default=False)
