...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NewProject.test'
        db.add_column(u'project_newproject', 'test',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NewProject.test'
        db.delete_column(u'project_newproject', 'test')
    ...
    models = {
        ...
        u'project.newproject': {
            ...
            'test': ('django.db.models.fields.CharField', [], {'max_length': '10', 'blank': 'True'}),
