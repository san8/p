...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'project_newproject', (
            ...
            ('file_type', self.gf('django.db.models.fields.CharField')(default='FASTQ', max_length=10)),
            ('total_fastq_files', self.gf('django.db.models.fields.CharField')(default='1', max_length=1)),
            ('fastq_file1', self.gf('django.db.models.fields.URLField')(max_length=200, blank=True)),
            ('file1_read', self.gf('django.db.models.fields.CharField')(default='Forward', max_length='8')),
            ('fastq_file2', self.gf('django.db.models.fields.URLField')(max_length=200, blank=True)),
            ('file2_read', self.gf('django.db.models.fields.CharField')(default='Backward', max_length='8')),
