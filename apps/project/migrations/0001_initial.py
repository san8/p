...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'project_newproject', (
            ...
            ('status_description', self.gf('django.db.models.fields.CharField')(default='Uploading Raw Files.', max_length=20)),
    ...
    models = {
        ...
        u'project.newproject': {
            ...
            'status_description': ('django.db.models.fields.CharField', [], {'default': "'Uploading Raw Files.'", 'max_length': '20'}),
