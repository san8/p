...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'project_newproject', 'total_fastq_files', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'NewProject.total_fastq_files'
        db.alter_column(u'project_newproject', 'total_fastq_files', self.gf('django.db.models.fields.IntegerField')(default=0))
    ...
    models = {
        ...
        u'project.newproject': {
            ...
            'total_fastq_files': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
