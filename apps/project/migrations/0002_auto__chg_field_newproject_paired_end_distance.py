...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'NewProject.paired_end_distance'
        db.alter_column(u'project_newproject', 'paired_end_distance', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'NewProject.paired_end_distance'
        db.alter_column(u'project_newproject', 'paired_end_distance', self.gf('django.db.models.fields.IntegerField')(default=0))
