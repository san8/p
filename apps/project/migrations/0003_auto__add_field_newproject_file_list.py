...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NewProject.file_list'
        db.add_column(u'project_newproject', 'file_list',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NewProject.file_list'
        db.delete_column(u'project_newproject', 'file_list')
