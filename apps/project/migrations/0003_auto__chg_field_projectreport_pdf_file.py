...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProjectReport.pdf_file'
        db.alter_column(u'project_projectreport', 'pdf_file', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'ProjectReport.pdf_file'
        db.alter_column(u'project_projectreport', 'pdf_file', self.gf('django.db.models.fields.URLField')(max_length=100))
