...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NewProject.start_pocessing'
        db.add_column(u'project_newproject', 'start_pocessing',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NewProject.start_pocessing'
        db.delete_column(u'project_newproject', 'start_pocessing')
    ...
    models = {
        ...
        u'project.newproject': {
            ...
            'start_pocessing': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
